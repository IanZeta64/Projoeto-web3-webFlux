...
import br.com.ada.usuarioapi.repositories.UsuarioInMemoryRepository;
...
public class UsuarioService {
    private final UsuarioInMemoryRepository repository;
    ...
    public Mono<Usuario> get(String usuarioId){
        return Mono.defer(() -> {
            ...
            return Mono.justOrEmpty(repository.get(UUID.fromString(usuarioId)));
        }).subscribeOn(Schedulers.boundedElastic());
    }
